...
# Load the data
SL = pd.read_csv("output/oncotypedx_SL_learn/SL_combined_GSE194040_Paclitaxel_AMG386_Trastuzumab.csv", skiprows=1)
STL = pd.read_csv("output/oncotypedx_stl_learn/STL_combined_GSE194040_Paclitaxel_AMG386_Trastuzumab.csv", skiprows=1)
ADALOSS = pd.read_csv("output/oncotypedx_adaloss/adaloss_combined_GSE194040_Paclitaxel_AMG386_Trastuzumab.csv", skiprows=1)
GRADNORM = pd.read_csv("output/oncotypedx_gradnorm/gradnorm_combined_GSE194040_Paclitaxel_AMG386_Trastuzumab.csv", skiprows=1)
OL_AUX = pd.read_csv("output/oncotypedx_ol_aux/ol_aux_combined_GSE194040_Paclitaxel_AMG386_Trastuzumab.csv", skiprows=1)
ARML = pd.read_csv("output/oncotypedx_aux_learn/AUX_combined_GSE194040_Paclitaxel_AMG386_Trastuzumab.csv", skiprows=1)
...
plt.title("GSE194040_TAC_AMG386_H AUROCs across 30 MCCV")
plt.ylabel("AUROC")
plt.xlabel("Method")
...
plt.savefig("output/boxplot_GSE194040_TAC_AMG386_H.pdf")
...
p_value_table.to_csv("output/pairwise_ttest_p_values.csv")

print("Pairwise t-test table saved as 'output/pairwise_ttest_p_values.csv'")
