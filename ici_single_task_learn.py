...
from data_utils import ICIDataset
...
# Create the dataset
dataset = ICIDataset(oncotype_file_paths=file_paths, cibersort_file_path= immune_paths)
...
results_df.to_csv(f'./output/MCCV_ici_STL_learn_{main_task_name}_{args.mccv}.csv', index=False)
