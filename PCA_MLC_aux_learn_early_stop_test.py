...
plt.suptitle('Training Loss = Binary cross entropy w/ logit loss + Auxiliary Loss (ARML)')
# Add a legend to distinguish between train and validation loss
plt.legend()
# save as png
plt.savefig(f'./output/MCCV_oncotype_AUX_learn_{args.main_task_file.replace(".csv", "")}_{args.mccv}.png')
