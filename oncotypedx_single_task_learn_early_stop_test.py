...
plt.legend()
# save as png
plt.savefig(f'./output/val_loss_adj_MCCV_oncotype_STL_learn_{args.main_task_file.replace(".csv", "")}_{args.mccv}.png')
...
results_df.to_csv(f'./output/val_loss_adj_MCCV_oncotype_STL_learn_{main_task_name}_{args.mccv}.csv', index=False)
